...
# install bluetooth required pakagesq
sudo apt install bluetooth bluedevil bluez bluez-tools pulseaudio-module-bluetooth blueman -y


# install other pakages
sudo apt install qtpass network-manager-gnome picom redshift redshift-gtk neofetch cmatrix feh lxappearance kitty htop exa rofi lxappearance flatpak -y
